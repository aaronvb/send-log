...
export const ClimbForm = ({ onAdd }: ClimbFormProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-800 rounded-lg p-4 flex flex-col gap-4">
      <div className="flex items-end gap-4">
        <div className="flex flex-col gap-1 flex-[3]">
          ...
          <input
            ...
            className="bg-gray-900 border border-gray-700 rounded px-3 py-2 text-gray-100 w-full focus:outline-none focus:border-blue-500"
        ...
        <div className="flex flex-col gap-1 flex-1">
          ...
          <select
            ...
            className="bg-gray-900 border border-gray-700 rounded px-3 py-2 h-[42px] text-gray-100 w-full focus:outline-none focus:border-blue-500"
          >
            {GRADES.map((g) => (
